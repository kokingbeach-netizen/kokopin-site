...
const FAQS = [
  ...
  {
    q: "GPSの精度、つまり現在地の精度はどのくらいですか？",
    a: "現在地の精度は、お使いのiPhoneが取得した位置情報に依存します。\n\niPhoneの位置情報はGPSだけでなく、周囲の環境や通信状況などをもとに取得されるため、現在いる場所によって精度が変動します。\n\n一般的な目安は以下のとおりです。\n\n・屋外（空が開けた場所）：数m〜10m程度\n・市街地・高層ビル周辺：10m〜30m程度\n・屋内・地下・トンネルなど：30m以上の誤差が発生する場合があります。\n\nKokoPinでは、取得時の現在地精度をアプリ内に表示しています。\n\n保存位置が少しズレた場合は、「候補を探す」や「ピン位置を再設定」機能をご利用ください。",
  },
];
