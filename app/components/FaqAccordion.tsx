...
const FAQS = [
  {
    q: "Siriが反応しない場合は？",
    a: "KokoPinはAppleのSiriを利用して動作します。\n「Hey Siri」が反応しない場合は、周囲の騒音やイヤホン・マイクの状態をご確認ください。\nまずは「Hey Siri、タイマー1分」など、通常のSiri操作ができるかお試しください。",
  },
  {
    q: "運転中に画面操作は必要ですか？",
  ...
  {
    q: "イヤホン装着中にうまく起動しません",
    a: "BluetoothイヤホンやAirPodsでは、マイクの状態や周囲の音によってSiriの反応が変わることがあります。\n片側のマイクにノイズや不具合がある場合は、正常な側のマイクに固定すると改善する場合があります。",
  },
  {
    q: "「ここピン」が別の言葉に認識されます",
